...
def send_welcome(message):
    ...
    bot.send_message(chat_id, 'Приветствую! Я кроки-бот, способный сориентировать Вас в мире переменчивой погоды и нестабильных цифр в финансовом мире. Для продолжения работы, пожалуйста, введите команду “/menu”') #Изменить приветственный текст(рассказать о боте)
